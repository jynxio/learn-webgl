...
function main () {
    ...
    /* 向顶点着色器传递旋转矩阵 */
    const xform_matrix = new Matrix4();

    // xform_matrix.setTranslate( 0.5, 0, 0 );
    // xform_matrix.rotate( 60, 0, 0, 1 );

    xform_matrix.setRotate( 90, 0, 0, 1 );
    xform_matrix.translate( 0.5, 0, 0 );

    const u_xform_matrix = gl.getUniformLocation( gl.program, "u_xformMatrix" );

    gl.uniformMatrix4fv( u_xform_matrix, false, xform_matrix.elements );
